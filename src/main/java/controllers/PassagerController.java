...
public class PassagerController {
    ...
    @FXML
    public void acceuilClient1(ActionEvent actionEvent) {
        try {
            // Charger le fichier FXML
    ...
    public void cherchertrajet(ActionEvent event){
        try {
            // Charger la vue Login.fxml
    ...
    public void voirrestrajet(ActionEvent event){
        try {
            // Charger la vue Login.fxml
    ...
    @FXML
    public void voirtouslesann(ActionEvent actionEvent) {
        try {
            // Charger le fichier FXML de l'interface admin
            ...
            Scene scene = new Scene(root);
            stage.setScene(scene);
            stage.setTitle("Accueil passager");
            stage.show();
