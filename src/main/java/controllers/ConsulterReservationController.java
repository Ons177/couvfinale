...
public class ConsulterReservationController {
   ...
   // @FXML private TableColumn<ReservationEvenement, Integer> colId;
    @FXML private TableColumn<ReservationEvenement, Integer> colEvent;
    @FXML private TableColumn<ReservationEvenement, Integer> colUser;
    ...
    public void initialize() {
        try {
            ...
            colEvent.setCellValueFactory(new PropertyValueFactory<>("idEvenement"));
            ...
            List<ReservationEvenement> reservations = service.recuperer();
