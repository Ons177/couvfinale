...
public class AfficherMesReponses {
        ...
        try {
            ...
            for (Reclamation rec : all) {
                if ("traité".equals(rec.getStatut())) {
                    FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/ReclamationReponduCard.fxml"));
    ...
    private void openDetail (entities.Reclamation rec){
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/DetailReclamationVoirRepondusAdmin.fxml"));
            Parent root = loader.load();
