...
public class FrenchProfanityAPI {
    ...
    private static final String API_USER = "410418288";  // Use your real API User
    private static final String API_SECRET = "HQkQ7DzMwW6wrerSjtSSDb9uKWdEk5GV";  // Use your real API Secret
