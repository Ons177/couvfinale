...
public class UserService {
    ...
    public Utilisateur getById(int id) {
        ...
        try (Connection conn = MyDatabase.getInstance().getConnection();  // Use your DB connection method
            ...
            if (rs.next()) {
                ...
                utilisateur.setPermis(rs.getString("permis"));
                utilisateur.setApproved(rs.getBoolean("isApproved")); // If this column exists
            }
