...
public class MailService {
    ...
    public static void send(String to, String subject, String content, final String user, final String appPassword) {
        ...
        try {
            ...
            // Envoi du message dans un thread séparé
